				...
				<div className="box">
					<div className="field">
  					...
  					<div className="control">
    					<textarea className="textarea" placeholder="Textarea" onChange={this.handleChange.bind(this)}></textarea>
  					</div>
					</div>
					<div className="control">
    				<button className="button is-link" onClick={this.handleSend.bind(this)}>Send</button>
  				</div>
				</div>
		);
	}
